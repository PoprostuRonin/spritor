...
public class DesignController implements Initializable {
    ...
    private ElementEditController loadElementEdit() {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/resources/fxml/elementedit.fxml"));
    ...
    private ElementGroupListController loadElementGroups() {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/resources/fxml/elementgroups.fxml"));
            Parent root = fxmlLoader.load();
    ...
    /**
     * Renders project in Design mode, outputs image to method {@link com.poprosturonin.controller.CanvasController#setImage(javafx.scene.image.Image)}
     */
    private void render() {
