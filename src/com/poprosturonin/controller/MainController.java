...
public class MainController implements Initializable {
    ...
    private AssetsController loadAssetsPane() {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/resources/fxml/assetspane.fxml"));
    ...
    private CanvasController loadCanvasPane() {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/resources/fxml/canvaspane.fxml"));
            Parent root = fxmlLoader.load();
    ...
    private DesignController loadDesignPane() {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/resources/fxml/designpane.fxml"));
            Parent root = fxmlLoader.load();
